package com.santosh.blog.exception;
...
public class AppExceptionHandler {
    ...
    public ResponseEntity<ErrorMessages> handleAppException(AppException exception) {
        return responseErrorMessages(Arrays.asList(exception.getMessage()), exception.getError().getStatus());
    }
    ...
    public ResponseEntity<ErrorMessages> handleException(Exception exception) {
        return responseErrorMessages(Arrays.asList("internal server error"), HttpStatus.UNPROCESSABLE_ENTITY);
    }
